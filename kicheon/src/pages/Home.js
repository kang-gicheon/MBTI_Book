    ...
    <div>
      ...
      <div className='books_con'>
        ...
        <div className='books_event'>
          <img src='https://contents.kyobobook.co.kr/sih/fit-in/300x0/pdt/9788954695053.jpg' 
          alt='책1이미지' className='book_img' />
      ...
      />)}
        ...
        <div className='books_event'>
          <img src='https://contents.kyobobook.co.kr/sih/fit-in/300x0/pdt/9788962625714.jpg'
          onClick={() => {
            setModal(true)
          }} alt='책1이미지' className='book_img' />
          <div className='books_exp'>
